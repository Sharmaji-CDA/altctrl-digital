...
const enterpriseFeatures = [
  {
    ...
    desc: "Gain deep insights into resolution rates, customer sentiment, and common friction points to...",
  },
  {
    icon: FileText,
    title: "Full Audit Trails",
    desc: "Maintain a complete, immutable log of all bot interactions and decisions, ensuring full transparen...",
  },
  {
    icon: Database,
    title: "Knowledge Base Integration",
    desc: "Fueled by your own knowledge base, ensuring it provides accurate, up-to-date information about yo...",
  },
];
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl flex flex-col justify-between h-full px-4 lg:px-8">
        ...
        <div className="mb-6 lg:mb-8 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 mb-2">
            <ShieldAlert size={12} className="text-indigo-400 animate-pulse" />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 items-stretch h-full">
          ...
          <motion.div
            ...
            className="flex flex-col justify-between rounded-2xl border border-slate-800/80 bg-slate-900/10 p-6 backdrop-blur-md lg:max-h-[480px]"
          >
            <div>
              ...
              <p className="mt-3 text-xs leading-relaxed text-slate-400">
                Full audit trails and knowledge base sync for 100% compliance adherence.
              </p>
            </div>
          ...
          <motion.div
            ...
            className="flex flex-col justify-between rounded-2xl border border-indigo-500/20 bg-gradient-to-b from-[#0b0d23] to-[#040510] p-6 shadow-[0_0_50px_rgba(79,70,229,0.02)] lg:max-h-[480px]"
          >
            <div>
              ...
              <p className="mt-3 text-xs leading-relaxed text-slate-300">
                Scale with confidence using enterprise-grade monitoring and actionable analytics.
              </p>
            </div>
