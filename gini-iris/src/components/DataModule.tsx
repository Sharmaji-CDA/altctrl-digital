...
export default function ModernCXSlides() {
  ...
  return (
    ...
    <section className="relative bg-black">
        ...
        <div className="relative z-20 flex min-h-screen items-center justify-center px-5 pt-24 pb-32">
            ...
            >
                ...
                <motion.button
                    ...
                    tracking-wide
                    text-white
                    shadow-[0_0_50px_rgba(236,28,36,0.35)]
                    "
                >
                    Get Started
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-1">
                                        ...
                                        <div className="flex flex-col items-center text-center">
                                            ...
                                            <p className="mt-1 text-[8px] leading-3 text-gray-400">
