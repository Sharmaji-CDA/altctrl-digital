...
export default function Footer() {
  ...
  const modernCxLinks = [
    ...
    { name: "Conversational AI", href: "/conversational-ai" },
  ...
  // 2. Structured data for socials
  const socialLinks = [
    { icon: FaTwitter, color: "hover:text-sky-400", href: "https://twitter.com/yourhandle" },
    { icon: FaLinkedinIn, color: "hover:text-blue-400", href: "https://linkedin.com/company/yourcompany" },
    { icon: FaYoutube, color: "hover:text-red-400", href: "https://youtube.com/yourchannel" },
  ];
    ...
    <footer className="relative overflow-hidden border-t border-white/5 bg-[#020617] px-4 pt-14 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px]">
        ...
        <div className="grid gap-10 border-b border-white/10 pb-10 md:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_1fr]">
          ...
          {/* BRAND */}
          <div>
            <Link to="/" className="relative z-20 inline-flex items-center">
              <img
                src="/logo.png"
                alt="Gini Iris"
                className="h-[52px] w-auto object-contain transition-all duration-300 sm:h-[60px] lg:h-[68px]"
              />
            </Link>
          ...
          {/* COLUMN 1 */}
          <div>
            <h3 className="text-[15px] font-bold text-white">Modern CX</h3>
